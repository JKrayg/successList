        ...
        <React.Fragment>
            <div style = {headerStyle} className = "row">
                <div className = "col-md-8">
                    ...
                    <img style = {{height: "75px", width: "75px", float: "left", marginLeft: "10px"}} src = "https://www.auburn.edu/administration/human_resources/hr_art/images/icons/010-calendar.png" alt = "calendar" />
                </div>
